...
To illustrate what happens to the MLE, we can compute the profile log-likelihood for a given sample with the following implementation.
...
plot(alpha_grid, ll_values, type = "l", lwd = 2,
     ...
     ylab = "Log-likelihood",
     main = "Gumbel loglikelihood")
abline(v = theta_true, col = "red", lwd = 2, lty = 2)
legend("topright", legend = c("True theta"), col = "red", lwd = 2, lty = 2)
```
